...
namespace NHibernate.Spatial.Type
{
	...
	/// </summary>
	[Serializable]
	public class MsSql2012GeographyType : GeometryTypeBase<SqlGeography>
	{
		private static readonly NullableType SqlGeographyType = new SqlGeographyType();

		/// <summary>
		/// Initializes a new instance of the <see cref="MsSql2012GeographyType"/> class.
		/// </summary>
		public MsSql2012GeographyType()
		...
		protected override SqlGeography FromGeometry(object value)
		{
			...
			try
			{
				MsSql2012GeographyWriter writer = new MsSql2012GeographyWriter();
		...
		protected override IGeometry ToGeometry(object value)
		{
			...
			MsSql2012GeographyReader reader = new MsSql2012GeographyReader();
