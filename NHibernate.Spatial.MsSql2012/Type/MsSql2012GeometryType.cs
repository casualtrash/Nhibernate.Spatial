...
namespace NHibernate.Spatial.Type
{
    ...
    /// </summary>
    [Serializable]
    public class MsSql2012GeometryType : GeometryTypeBase<SqlGeometry>
    {
		private static readonly NullableType SqlGeometryType = new SqlGeometryType();
		
		/// <summary>
        /// Initializes a new instance of the <see cref="MsSql2012GeometryType"/> class.
        /// </summary>
        public MsSql2012GeometryType()
        ...
        protected override SqlGeometry FromGeometry(object value)
        {
        	...
        	try
        	{
        		MsSql2012GeometryWriter writer = new MsSql2012GeometryWriter();
        		SqlGeometry sqlGeometry = writer.Write(geometry);
        		return sqlGeometry;
        	}
        	catch (FormatException ex)
        	{
        		if (ex.Message.StartsWith("24117:") /* The LineString input is not valid because it does not have enough distinct points. A LineString must have at least two distinct points.*/ ||
        ...
        protected override IGeometry ToGeometry(object value)
        {
			...
			MsSql2012GeometryReader reader = new MsSql2012GeometryReader();
