...
namespace NHibernate.Spatial.Dialect
{
	...
	/// 
	/// </summary>
	public abstract class MsSql2012SpatialDialect : MsSql2012Dialect, ISpatialDialect
	{
		...
		private new void RegisterFunctions()
		{
		...
		public SqlString GetSpatialRelateString(object geometry, object anotherGeometry, object pattern, bool isStringPattern, bool criterion)
		{
			if (pattern == null)
			{
				throw new ArgumentNullException("pattern", 
					"Ms SQL 2012 does not supports the syntax returning a DE-9IM for the two geometries. For STRelate the 'intersection_pattern_matrix' is mandatory and the result is a boolean.");
			}
